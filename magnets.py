...
class Magnet:
    magnetX = ((100.0, 0.0, 100.0), (0.0, 0.0, 100.0))  # points creating vector X (magnet X) in cm
    magnetY = ((50.0, 0.0, 0.0), (50.0, 100.0, 0.0))  # points creating vector Y (magnet Y) in cm
